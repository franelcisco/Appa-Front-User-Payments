...
import type { ValidateMobilePaymentRequest, ValidateMobilePaymentResponse } from "@/types/dtos/payments.dto";
      ...
      <div className="flex flex-col justify-center items-center gap-2 mt-3">
        {isValidPhone ? (
          <>
            ...
            <Alert
              className="bg-bone-beige text-appa-primary px-4 py-2 text-xs"
          ...
          <div className="bg-appa-gray p-2 rounded-lg shadow-md text-center">
