...
export function MobilePaymentResult({ result, onBack, statusPageUrl, orderNo }: Props) {
    ...
    <div className="max-w-md w-full text-center">
      {!result.success ? (
        ...
        <div className="flex flex-col gap-5">
          <SuccessValidated orderNo={orderNo} inProcess={false} statusPageUrl={statusPageUrl} />
          {result.message !== "" && (
            <Alert
              className="bg-bone-beige-light text-bone-primary text-xxs px-4 py-2"
