...
export function DirectDebitOTP({
  ...
  const onSubmit: SubmitHandler<ValidateOTPRequest> = useCallback(
    async (data) => {
      ...
      setLoading(false);
      console.log("Validate OTP Result:", response);
      onResult(response);
    },
    [onResult]
  );
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <ModalBody>
            <div>
              ...
              <div className="w-full rounded-xl bg-appa-gray p-1 text-center mt-2">
                <p className="text-xs mt-2">
                  {`Debe ingresar el código enviado a su teléfono, o correo dentro de`}{" "}
            ...
            {loading && (
              <div className="text-gray-500 bg-appa-gray font-bold mt-4 animate-pulse text-center text-sm">
            ...
            <div className="flex justify-center mt-2">
              <Button
                disabled={loading}
                className="bg-appa-yellow hover:bg-appa-yellow text-appa-primary"
                type="submit"
              >
