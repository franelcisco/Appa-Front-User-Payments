          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <Card className="max-w-md w-full">
              ...
              <div className="flex flex-col gap-4 mb-4">
                <ZellePaymentDetails />
                <Alert
                  className="bg-bone-beige text-appa-primary text-xxs px-4 py-2"
                  icon={HiInformationCircle}
                >
                  No colocar la referencia correctamente en el zelle, puede
                  generar retrasos de hasta una semana para verificar tu pago
                </Alert>
                <div>
